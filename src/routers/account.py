...
async def list_all(
    ...
    business_status: list[str] | None = Query(default=None),
    waba_interested: str | None = None,
    is_priority_account: str | None = None,
    cb_condition: str | None = None,
    cb_users: list[int] | None = Query(default=None),
...
def get_status_journey(
    ...
    return repo.get_accounts_status_journey(db, company_id=1, page=page, limit=limit)


@router.get(
    "/status-journey/{account_id}", response_model=AccountStatusJourneyResponse
)
